...
import { Search, Filter, Calendar, Users, Clock, ArrowUpRight, TrendingUp, ShieldCheck } from "lucide-react";
import { Button } from "@/components/ui/button";
import { cn } from "@/lib/utils";

export default function DGMissions() {
  return (
    <div className="space-y-10 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="font-display text-4xl font-black text-foreground tracking-tight">Mission Oversight</h1>
          <p className="text-muted-foreground font-medium mt-2">Executive monitoring of all strategic training initiatives.</p>
        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:border-l lg:border-border/50 lg:pl-12">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest">Milestone</span>
                    </div>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-sm font-bold text-foreground">12 Personnel</span>
                  </div>
