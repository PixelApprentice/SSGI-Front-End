...
export default function NegotiatorDashboard() {
  return (
    <div className="space-y-10">
      <div>
        <h1 className="font-display text-4xl font-black text-foreground tracking-tight">Lead Negotiator</h1>
        <p className="text-muted-foreground font-medium mt-2">Overseeing strategic training agreements and technical terms.</p>
      </div>
