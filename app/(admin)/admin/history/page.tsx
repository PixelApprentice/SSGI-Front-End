...
import { History, Search, Filter, ArrowUpRight, Clock, ShieldAlert } from "lucide-react";
import { Button } from "@/components/ui/button";
import { cn } from "@/lib/utils";

const systemLogs = [
  { id: "SYS-9901", action: "Role Reassignment", target: "Henok Girma", initiator: "System Admin", date: "Mar 30, 2026", time: "10:15" },
  { id: "SYS-9895", action: "Security Policy Update", target: "Global Access", initiator: "System Admin", date: "Mar 29, 2026", time: "16:40" },
  { id: "SYS-9882", action: "Mission Authorization", target: "TRQ-0046", initiator: "Prof. Solomon Belay", date: "Mar 28, 2026", time: "09:30" },
  { id: "SYS-9870", action: "Account Provisioned", target: "Dawit Kebede", initiator: "System Admin", date: "Mar 25, 2026", time: "11:20" },
];
    ...
    <div className="space-y-10 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-muted-foreground font-medium mt-2">Comprehensive audit trail of all security and operational events.</p>
        </div>
        <div className="flex items-center gap-3">
          <Button variant="outline" className="h-12 rounded-2xl border-border/50 bg-muted/30 px-6 font-bold text-xs uppercase tracking-widest gap-2">
            <ShieldAlert className="h-4 w-4" /> Integrity Report
          </Button>
        </div>
      </div>
      ...
      <div className="glass-card overflow-hidden">
        ...
        <Button variant="ghost" className="w-full h-14 rounded-none text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary">Download Comprehensive Archive</Button>
      </div>
    </div>
  );
}
